...
impl WasiCtxBuilder {
    ...
    /// Enables replacing the Host's filesystem with GEDS
    ///
    /// This is disabled by default.
    pub fn enable_geds(&mut self, enable: bool) -> &mut Self {
        self.use_geds = enable;
        self
    }

    /// Enables subscribing to changes in a GEDS bucket.
    ///
    /// This is disabled by default.
    pub fn geds_subscribe(&mut self, enable: bool) -> &mut Self {
        self.geds_subscribe = enable;
        self
    }
...
pub struct WasiCtx {
    ...
    pub(crate) use_geds: bool,
    pub(crate) geds_subscribe: bool,
}
